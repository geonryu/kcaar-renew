...
var AccordionButton = React2.forwardRef(({
...
var AccordionItem = React4.forwardRef(({
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component2 = "div",
  bsPrefix,
  className,
  ...
  return (0, import_jsx_runtime3.jsx)(AccordionItemContext_default.Provider, {
    value: contextValue,
...
var Accordion = React5.forwardRef((props, ref) => {
  const {
    // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
    as: Component2 = "div",
    activeKey,
  ...
  return (0, import_jsx_runtime4.jsx)(AccordionContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime4.jsx)(Component2, {
      ref,
      ...controlledProps,
      className: (0, import_classnames4.default)(className, prefix, flush && `${prefix}-flush`)
    })
  });
});
...
var divWithClassName_default = (className) => React6.forwardRef((p, ref) => (0, import_jsx_runtime5.jsx)("div", {
  ...p,
  ref,
...
var AlertHeading = React7.forwardRef(({
  className,
  bsPrefix,
...
var Button = React8.forwardRef((_ref, ref) => {
  let {
    as: asProp,
    disabled
  ...
  return (0, import_jsx_runtime7.jsx)(Component2, Object.assign({}, props, buttonProps, {
    ref
  }));
});
...
var context = React22.createContext(null);
...
function useTimeout() {
  ...
  const handleRef = (0, import_react24.useRef)();
...
function useForceUpdate() {
  const [, dispatch] = (0, import_react27.useReducer)((state) => !state, false);
  return dispatch;
}
...
function $b5e257d569688ac6$export$535bd6ca7f90a273() {
  if (typeof (0, import_react32.default)["useSyncExternalStore"] === "function")
    return (0, import_react32.default)["useSyncExternalStore"]($b5e257d569688ac6$var$subscribe, $b5e257d569688ac6$var$getSnapshot, $b5e257d569688ac6$var$getServerSnapshot);
...
var FormCheck = React64.forwardRef(({
  ...
  const innerFormContext = (0, import_react43.useMemo)(() => ({
...
var FormGroup = React67.forwardRef(({
  ...
  const context4 = (0, import_react45.useMemo)(() => ({
    controlId
  }), [controlId]);
...
var Switch = React72.forwardRef((props, ref) => (0, import_jsx_runtime70.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
function NoopTransition({
  ...
  const child = (0, import_react53.cloneElement)(children, {
    ref: combinedRef
  });
  if (inProp)
    return child;
...
var Modal = (0, import_react55.forwardRef)((_ref, ref) => {
  ...
  return (0, import_jsx_runtime81.jsx)(import_jsx_runtime82.Fragment, {
    children: import_react_dom.default.createPortal((0, import_jsx_runtime83.jsxs)(import_jsx_runtime82.Fragment, {
...
var AbstractModalHeader = React88.forwardRef(({
  ...
  const context4 = (0, import_react56.useContext)(ModalContext_default);
...
var Modal2 = React91.forwardRef(({
  ...
  const renderBackdrop = (0, import_react57.useCallback)((backdropProps) => (0, import_jsx_runtime91.jsx)("div", {
    ...backdropProps,
...
var Offcanvas = React102.forwardRef(({
  ...
  const renderBackdrop = (0, import_react63.useCallback)((backdropProps) => (0, import_jsx_runtime102.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React103.forwardRef((props, ref) => {
  const context4 = (0, import_react64.useContext)(NavbarContext_default);
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime119.jsxs)(import_jsx_runtime118.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react70.cloneElement)(children, triggerProps), (0, import_jsx_runtime117.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
function createButton(name, defaultValue, label = name) {
  const Button3 = React115.forwardRef(({
    children,
    ...props
...
function useTabPanel(_ref) {
  ...
  const context4 = (0, import_react72.useContext)(TabContext_default);
  if (!context4)
  ...
  const {
    ...
    getControlledId,
    getControllerId
  } = context4, rest = _objectWithoutPropertiesLoose10(context4, _excluded22);
...
var TabContent = React128.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var TabPane = React129.forwardRef(({
  bsPrefix,
  transition,
  ...props
}, ref) => {
...
var ToastFade = React132.forwardRef((props, ref) => (0, import_jsx_runtime140.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContext = React133.createContext({
  // eslint-disable-next-line @typescript-eslint/no-empty-function
  onClose() {
  }
});
...
var ToastHeader = React134.forwardRef(({
  bsPrefix,
  closeLabel = "Close",
  closeVariant,
  closeButton = true,
  ...
  const context4 = (0, import_react74.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
...
var ToastBody = React135.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ToastContainer = React137.forwardRef(({
  bsPrefix,
  position,
  containerPosition,
  className,
...
var noop6 = () => void 0;
var ToggleButton = React138.forwardRef(({
  bsPrefix,
  name,
  className,
  checked,
...
var ToggleButtonGroup = React139.forwardRef((props, ref) => {
  const {
    children,
    type = "radio",
    name,
