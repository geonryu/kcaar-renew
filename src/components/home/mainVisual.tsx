                ...
                >
                    <SwiperSlide>
                        ...
                        <div className="txt fs-5 text-primary-black fw-bold text-center col-md-8 mx-auto mt-3 px-md-2">
                            한국접근성평가연구원은 과학기술정보통신부 산하 한국지능정보사회진흥원이 지정한 우선구매추천을 위한 무인정보단말기 접근성 검증평가 기관으로 지정된 바 있으며, 본 조사에서도 가능한 범위에서 최대한 동일한 접근성 검증평가 방법을 적용하여 실시하였다. 장애인차별금지법에 기반한 키오스크 접근성 보고서 제1권과, 이와 별도의 부속 문서로 고령자들의 키오스크 접근성을 평가한 보고서 2부(대중교통시설, 식음료매장)를 발간하였다. 접근성 보고서 제1권 및 고령자 보고서 2종은 자료실에 업로드 되어 있다.
                        </div>
                    </SwiperSlide>
                    <SwiperSlide>
