        ...
        const fetchBoardDatas = async () => {
            ...
            unsubscribe = onSnapshot(boardQuery, (snapshot) => {
                const boardData: any = snapshot.docs.map((doc) => {
                    const { id, createdAt, tit, content, attached, attachedName, email, writer, writerId, ans } = doc.data();
                    return {
                        id, createdAt, tit, content, attached, attachedName, email, writer, writerId, ans
                    };
                });
