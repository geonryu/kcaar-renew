...
import AccessCounsultation from "../../components/center/counsultation/counsultation";
        ...
        <Wrap>
            <LocalNavigation 
                LNB={[
                    ...
                    {"tit" : "접근성협의체", "to" : "/center/counsultation", "isActive": "true", "key": "councultation" },
                    {"tit" : "오시는 길", "to" : "/center/location", "isActive": "false", "key": "location" },
                ]}
            ></LocalNavigation>
            <AccessCounsultation></AccessCounsultation>
        </Wrap>
    )
}